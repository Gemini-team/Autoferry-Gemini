...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n)vehiclecontroller/vehiclecontroller.proto\x12\x11vehiclecontroller\"B\n\x0c\x44riveRequest\x12\x0e\n\x06torque\x18\x01 \x01(\x02\x12\r\n\x05\x61ngle\x18\x02 \x01(\x02\x12\x13\n\x0b\x62rakeTorque\x18\x03 \x01(\x02\" \n\rDriveResponse\x12\x0f\n\x07success\x18\x01 \x01(\x08\x32\xa7\x03\n\x11VehicleController\x12S\n\x0c\x44riveForward\x12\x1f.vehiclecontroller.DriveRequest\x1a .vehiclecontroller.DriveResponse\"\x00\x12T\n\rDriveBackward\x12\x1f.vehiclecontroller.DriveRequest\x1a .vehiclecontroller.DriveResponse\"\x00\x12L\n\x05Steer\x12\x1f.vehiclecontroller.DriveRequest\x1a .vehiclecontroller.DriveResponse\"\x00\x12K\n\x04Idle\x12\x1f.vehiclecontroller.DriveRequest\x1a .vehiclecontroller.DriveResponse\"\x00\x12L\n\x05\x42rake\x12\x1f.vehiclecontroller.DriveRequest\x1a .vehiclecontroller.DriveResponse\"\x00\x42?\n\"io.grpc.examples.vehiclecontrollerB\x11VehicleControllerP\x01\xa2\x02\x03HLWb\x06proto3')
)
...
_DRIVEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='brakeTorque', full_name='vehiclecontroller.DriveRequest.brakeTorque', index=2,
...
_VEHICLECONTROLLER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='Steer',
    full_name='vehiclecontroller.VehicleController.Steer',
    index=2,
    containing_service=None,
    input_type=_DRIVEREQUEST,
    output_type=_DRIVERESPONSE,
  ...
  _descriptor.MethodDescriptor(
    name='Idle',
    full_name='vehiclecontroller.VehicleController.Idle',
    index=3,
    containing_service=None,
    input_type=_DRIVEREQUEST,
    output_type=_DRIVERESPONSE,
  ...
  _descriptor.MethodDescriptor(
    name='Brake',
    full_name='vehiclecontroller.VehicleController.Brake',
    index=4,
    containing_service=None,
    input_type=_DRIVEREQUEST,
    output_type=_DRIVERESPONSE,
