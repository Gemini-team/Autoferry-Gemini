...
if __name__ == '__main__':
    ...
    while True:
        ...
        if command == "w":
            ...
            success = vehiclecontroller_stub.DriveForward(vehiclecontroller_pb2.DriveRequest(torque=1.0, angle=0.0))
        elif command == "a":
            success = vehiclecontroller_stub.Drive(vehiclecontroller_pb2.DriveRequest(torque=0.0, angle = -1.0))
        elif command == "s":
            #success = vehiclecontroller_stub.Drive(vehiclecontroller_pb2.DriveRequest(torque=-1.0, angle = 0.0))
            success = vehiclecontroller_stub.DriveBackward(vehiclecontroller_pb2.DriveRequest(torque=-1.0, angle=0.0))
        elif command == "d":
            success = vehiclecontroller_stub.Drive(vehiclecontroller_pb2.DriveRequest(torque=0.0, angle = 1.0))
        elif command == " ":
